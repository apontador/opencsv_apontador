...
public class BeanToCsv<T> {
    ...
    public void write(MappingStrategy<T> mapper, CSVWriter csv, T object) {
		...
		try
		{
			...
			String[] line = processObject(getters, object);
			csv.writeNext(line);
	...
	public void writeHeader(MappingStrategy<T> mapper, CSVWriter csv) {
